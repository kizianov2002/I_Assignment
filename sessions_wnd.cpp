...
sessions_wnd::sessions_wnd(QSqlDatabase &db, s_data_app &data_app, QWidget *parent)
   : db(db), QDialog(parent),
   data_app(data_app),
   ui(new Ui::sessions_wnd)
{
    ui->setupUi(this);
...
void sessions_wnd::refresh_sessions_tab() {
    ...
    ui->tab_sessions->setColumnWidth( 0,  2);     // id,
    ui->tab_sessions->setColumnWidth( 1,  2);     // ,
    ui->tab_sessions->setColumnWidth( 2,150);     // ,
    ui->tab_sessions->setColumnWidth( 3,  2);     // ,
    ui->tab_sessions->setColumnWidth( 4,150);     // ,
    ui->tab_sessions->setColumnWidth( 5,  2);     // ,
